...
class Coupon_Referral_Program {
	...
	private function define_admin_hooks() {
		...
		//crp-referral_setting
		$this->loader->add_action("woocommerce_update_options_crp-referral_setting",$plugin_admin,'mwb_save_settings',10,1);
		$this->loader->add_filter('woocommerce_admin_reports',$plugin_admin,'mwb_crp_reports',10,1);
	}
