                  ...
                  <li>
                    <div class="mwb-pr-popup-left-rewards">                      
                        <div class="mwb-pr-popup-rewards-left-content">
                          ...
                          <?php if($public_obj->get_referral_coupon_amount_type() == 'mwb_cpr_referral_fixed') :?>
                          <p><?php _e('3. You will get the discount coupon of  ','coupon-referral-program'); echo '<span class="mwb_cpr_highlight" style="color:'.Coupon_Referral_Program_Admin::get_selected_color().'">'.wc_price($public_obj->get_referral_discount_order()).'</span>';_e(' on the referral purchase.','coupon-referral-program');?></p>
                          <?php endif;?>
                          <?php if( $public_obj->get_referral_coupon_amount_type() == 'mwb_cpr_referral_percent') :?>
                           <p><?php _e('3. You will get the discount coupon of ','coupon-referral-program'); echo '<span class="mwb_cpr_highlight" style="color:'.Coupon_Referral_Program_Admin::get_selected_color().'">'.$public_obj->get_referral_discount_order().'%</span>';$public_obj->get_referral_coupon_amount_limit_html()._e(' of the referral order.','coupon-referral-program');?>
                           </p>
                          <?php endif;?>
