		...
		<tbody>
				...
				<td class="forminp forminp-text">
					...
					?>
						...
						<select id="mwb_wpr_points_expiration_time_drop" name="mwb_wpr_points_expiration_time_drop" style="width: 10%;">
							<option value="days"<?php if(isset($mwb_wpr_points_expiration_time_drop)){ if($mwb_wpr_points_expiration_time_drop == "days"){?>selected="selected"<?php }}?>><?php _e('Days',MWB_WPR_Domain);?></option>
							<option value="weeks"<?php if(isset($mwb_wpr_points_expiration_time_drop)){ if($mwb_wpr_points_expiration_time_drop == "weeks"){?>selected="selected"<?php }}?>><?php _e('Weeks',MWB_WPR_Domain);?></option>
							<option value="months"<?php if(isset($mwb_wpr_points_expiration_time_drop)){ if($mwb_wpr_points_expiration_time_drop == "months"){?>selected="selected"<?php }}?>><?php _e('Months',MWB_WPR_Domain);?></option>
							<option value="years"<?php if(isset($mwb_wpr_points_expiration_time_drop)){ if($mwb_wpr_points_expiration_time_drop == "years"){?>selected="selected"<?php }}?>><?php _e('Years',MWB_WPR_Domain);?></option>	
						</select>						
				</td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<td class="forminp forminp-text">
					...
					<p class="description"><?php _e('Use these shortcodes for providing an appropriate message for your customers ', MWB_WPR_Domain);?><?php echo '[TOTALPOINT]'; _e(' for their Total Points ',MWB_WPR_Domain); echo ' [EXPIRYDATE]';_e(' for the Expiration Date ',MWB_WPR_Domain); ?></p>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
