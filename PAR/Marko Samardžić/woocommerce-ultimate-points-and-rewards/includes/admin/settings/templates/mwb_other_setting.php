...
{	
	...
	elseif (isset($_POST['mwb_wpr_thankyouorder_enable']) && !empty($_POST['mwb_wpr_thankyouorder_enable'])) {
			...
			<tr valign="top">
				...
				<td class="forminp forminp-text">
					...
					<label for="mwb_wpr_thankyouorder_enable">
						<input type="checkbox" <?php echo ($thankyouorder_enable == 'on')?"checked='checked'":""?> name="mwb_wpr_thankyouorder_enable" id="mwb_wpr_thankyouorder_enable" class="input-text"> <?php _e('Enable ThankYou Gift Coupon to Customers.', 'woocommerce-ultimate-gift-card');?>
					</label>						
				</td>
			</tr>
			<tr valign="top" class="mwb_wpr_thankyouorder_row" >
			<th>
				<label for="mwb_wpr_thankyouorder_fields"><?php _e('Enter Coupon Amount within Order Range', 'woocommerce-ultimate-gift-card')?></label>
			</th>
			<td class="forminp forminp-text">
