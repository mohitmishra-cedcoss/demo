			...
			if(isset($screen->id))
			{
				...
				{	
					...
					$mwb_wpr = array(
							...
							'Points_text'   => __('Per ', MWB_WPR_Domain).get_woocommerce_currency_symbol(). __(' Points Conversion', MWB_WPR_Domain),
							'Points'      =>__("Points ", MWB_WPR_Domain),
							'curreny_symbool'=>get_woocommerce_currency_symbol(),
							'upload_badges'  =>__('Upload Badge',MWB_WPR_Domain),
							'upload_text'	=>__('Upload',MWB_WPR_Domain),
					);
