...
class Mwb_Wpr_Custom_Widget extends WP_Widget {
    ...
    */
    public function widget( $args, $instance ) { 
        ...
        $mypoint    = isset($instance['mypoint']) && !empty($instance['mypoint'])? $instance['mypoint'] : __('Total Point:',MWB_WPR_Domain);
        $mycurrentlevel    = isset($instance['mycurrentlevel']) && !empty($instance['mypoint'])? $instance['mycurrentlevel'] : __('User Level:',MWB_WPR_Domain);
        $membershipexpiration    = isset($instance['membershipexpiration']) && !empty($instance['membershipexpiration'])? $instance['membershipexpiration'] : __('Expiration Date:',MWB_WPR_Domain);
    ...
    */
    ...
    <p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:',MWB_WPR_Domain); ?></label> 
        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></p> 
        <p>
        <label for="<?php echo $this->get_field_id('mypoint'); ?>"><?php _e('Total Point Text:',MWB_WPR_Domain); ?></label> 
        ...
        <p>
        <label for="<?php echo $this->get_field_id('mycurrentlevel'); ?>"><?php _e('User Level:',MWB_WPR_Domain); ?></label> 
        ...
        <p>
        <label for="<?php echo $this->get_field_id('membershipexpiration'); ?>"><?php _e('Expiration Text:',MWB_WPR_Domain); ?></label> 
