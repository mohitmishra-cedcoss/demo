( function ( $ ) {
	...
	{	
		...
		$(document).on("click",".mwb_wpr_upload_badge",function(e){
			e.preventDefault();
			var count=$(this).data('id');
			var id=$('#mwb_wpr_image_display_'+count).html();
				var image = wp.media({ 
					title: 'Upload Image',
				...
				.on('select', function(e){
					...
					$('#mwb_wpr_image_display_'+count).attr("src",image_url);
					$('#mwb_wpr_membership_badge_'+count).val(image_url);
				});
		});
		$(document).on("click",".mwb_wpr_reset_badge",function(e){
			e.preventDefault();
    	...
    	jQuery(document).on('click','.mwb_wpr_repeat_button',function(){
    		...
    		{	
	    		...
	    		html+='<tr valign="top"><th scope="row" class="titledesc"><label for="mwb_wpr_coupon_conversion_value_membership">'+mwb_wpr.upload_badges+'</th><td><label for="mwb_wpr_coupon_conversion_membership_value"><input type="text"  value="" name="mwb_wpr_membership_badge_'+count+'"id="mwb_wpr_membership_badge_'+count+'" class="input-text wc_input_price mwb_wpr_new_woo_ver_style_text"><div><button class="mwb_wpr_upload_badge button"data-id="'+count+'"id="mwb_wpr_upload_badge_'+count+'">'+mwb_wpr.upload_text+'</button><img id="mwb_wpr_image_display_'+count+'"src="" width="100" height="100" ></td></tr>';
	    		html+='<tr valign="top"><th scope="row" class="titledesc"><label for="mwb_wpr_membership_discount">'+mwb_wpr.Discounttext+'</label></th><td class="forminp forminp-text"><label for="mwb_wpr_membership_discount"><input type="number" min="1" value="" name="mwb_wpr_membership_discount_'+count+'" id="mwb_wpr_membership_discount_'+count+'" class="input-text" required></label></td><input type = "hidden" value="'+count+'" name="hidden_count"></tr>';
	    		html+='<tr valign="top"><th scope="row" class="titledesc"><label for="mwb_wpr_coupon_conversion_value_membership">'+mwb_wpr.Points_text+'</label></th><td class="forminp forminp-text"><label for="mwb_wpr_coupon_conversion_membership_value">'+mwb_wpr.curreny_symbool+'<input type="text"name="mwb_wpr_membership_conversion_price_'+count+'"id="mwb_wpr_membership_conversion_price_'+count+'"class="input-text wc_input_price mwb_wpr_new_woo_ver_style_text">=<input type="number" min="1" name="mwb_wpr_membership_conversion_points_'+count+'"id="mwb_wpr_membership_conversion_points_'+count+'" step="0.1"class="input-text wc_input_price mwb_wpr_new_woo_ver_style_text">'+mwb_wpr.Points+'</td></tr></table></div>';
