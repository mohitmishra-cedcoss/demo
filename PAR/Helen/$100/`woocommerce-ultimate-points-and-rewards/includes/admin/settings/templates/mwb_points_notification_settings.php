...
if(isset($_POST['mwb_wpr_save_notification']))
{
	...
	if($current_tab=="mwb_wpr_notificatin_tab")
	{
		...
		$mwb_wpr_point_on_order_total_range_desc = (isset($_POST['mwb_wpr_point_on_order_total_range_desc']) && $_POST['mwb_wpr_point_on_order_total_range_desc'] !=null) ? stripcslashes($_POST['mwb_wpr_point_on_order_total_range_desc']) :  __('Your ',MWB_WPR_Domain).'[DEDUCTCARTPOINT]'.__(' Points has been deducted from your account, now your Total Point is ',MWB_WPR_Domain).'[TOTALPOINTS].';
		$mwb_wpr_point_on_order_total_range_subject = (isset($_POST['mwb_wpr_point_on_order_total_range_subject']) && $_POST['mwb_wpr_point_on_order_total_range_subject'] !=null) ? stripcslashes($_POST['mwb_wpr_point_on_order_total_range_subject']) : __("Points Deducted!!",MWB_WPR_Domain);		
		...
		$mwb_wpr_notificatin_array['mwb_wpr_point_on_order_total_range_subject'] = $mwb_wpr_point_on_order_total_range_subject;
		$mwb_wpr_notificatin_array['mwb_wpr_point_on_order_total_range_desc'] = $mwb_wpr_point_on_order_total_range_desc;
...
<?php if(!is_array($mwb_wpr_notification_settings)): $mwb_wpr_notification_settings = array(); endif;?>
	<?php 
		...
		$mwb_wpr_point_on_order_total_range_subject = isset($mwb_wpr_notification_settings['mwb_wpr_point_on_order_total_range_subject']) ? $mwb_wpr_notification_settings['mwb_wpr_point_on_order_total_range_subject'] : __("Points Added!",MWB_WPR_Domain);	
		$mwb_wpr_point_on_order_total_range_desc = isset($mwb_wpr_notification_settings['mwb_wpr_point_on_order_total_range_desc']) ? $mwb_wpr_notification_settings['mwb_wpr_point_on_order_total_range_desc'] :  __('Your ',MWB_WPR_Domain).'[ORDERTOTALPOINT]'.__(' Points has been added in your account, now your Total Point is ',MWB_WPR_Domain).'[TOTALPOINTS].';
	?>
<div class="mwb_table">
	<table class="form-table mwb_wpr_notificatin_tab mwp_wpr_settings">
		...
		</div><div class="mwb_wpr_email_wrapper">
			<div class="mwb_wpr_email_wrapper_text" >
				<h2><?php _e("Points On Order Total Range",MWB_WPR_Domain);?></h2>
			</div>
			<div class="mwb_wpr_email_wrapper_content" style="display:none">
				<table class="form-table mwb_wpr_notificatin_tab mwp_wpr_settings">
				<tbody>	
				<tr valign="top">
					<th scope="row" class="titledesc">
						<label for="mwb_wpr_point_on_order_total_range_subject"><?php _e('Email Subject', MWB_WPR_Domain)?></label>
					</th>
					<td class="forminp forminp-text">
						<?php 
						$attribute_description = __('Input subject for email.', MWB_WPR_Domain);
						echo wc_help_tip( $attribute_description );
						?>
						<label for="mwb_wpr_point_on_order_total_range_subject">
							<input type="text" name="mwb_wpr_point_on_order_total_range_subject" value="<?php echo $mwb_wpr_point_on_order_total_range_subject;?>" id="mwb_wpr_point_on_order_total_range_subject" class="input-text mwb_wpr_new_woo_ver_style_text"> 
						</label>						
					</td>
				</tr>
				<tr valign="top">
					<th scope="row" class="titledesc">
						<label for="mwb_wpr_point_on_order_total_range_desc"><?php _e('Email Description', MWB_WPR_Domain)?></label>
						<?php 
						$attribute_description = __('Enter Email Description for user.', MWB_WPR_Domain);
						echo wc_help_tip( $attribute_description );
						?>
					...
					<td class="forminp forminp-text">
					<?php _e('Use ',MWB_WPR_Domain );echo '[ORDERTOTALPOINT]'; _e(' shortcode in place of points which has been added ',MWB_WPR_Domain);echo '[USERNAME]';_e(' shortcode in place of username ',MWB_WPR_Domain);echo '[TOTALPOINTS]';_e(' shortcode in place of Total Points.', MWB_WPR_Domain);?>
						<label for="mwb_wpr_point_on_order_total_range_desc">
							<?php 
							$content=stripcslashes($mwb_wpr_point_on_order_total_range_desc);
							$editor_id="mwb_wpr_point_on_order_total_range_desc";
							$settings = array(
		                            'media_buttons'    => false,
		                            'drag_drop_upload' => true,
		                            'dfw'              => true,
		                            'teeny'            => true,
		                            'editor_height'    => 200,
		                            'editor_class'       => 'mwb_wpr_point_on_order_total_range_desc',
		                            'textarea_name'    => "mwb_wpr_point_on_order_total_range_desc"
		                    );
							 wp_editor($content,$editor_id,$settings); ?>
						</label>						
					</td>
