...
if(isset($_POST['mwb_wpr_save_general']))
{
	...
	if($current_tab=="mwb_wpr_general_setting")
	{
		...
		$mwb_social_selection = array('Facebook' => $mwb_wpr_facebook,
										'Twitter' =>$mwb_wpr_twitter,
										'Google' =>$mwb_wpr_google,
										'Email' =>$mwb_wpr_email
									);
		...
		$mwb_text_points_value = (isset($_POST['mwb_wpr_general_text_points']) && $_POST['mwb_wpr_general_text_points'] !=null) ? stripcslashes($_POST['mwb_wpr_general_text_points']) : __('My Points',MWB_WPR_Domain);
		...
		$mwb_wpr_purchase_product_text = (isset($_POST['mwb_wpr_purchase_product_text']) && $_POST['mwb_wpr_purchase_product_text'] !=null) ? stripcslashes($_POST['mwb_wpr_purchase_product_text']) : __('Use your Points for purchasing this Product',MWB_WPR_Domain);
		...
		$mwb_wpr_assign_pro_text = (isset($_POST['mwb_wpr_assign_pro_text']) && $_POST['mwb_wpr_assign_pro_text'] !=null) ? stripcslashes($_POST['mwb_wpr_assign_pro_text']) :  __('Product Points',MWB_WPR_Domain);
...
<div class="mwb_table">
	<table class="form-table mwb_wpr_general_setting mwp_wpr_settings">
		<?php 
			...
			$mwb_wpr_assign_pro_text = isset($general_settings['mwb_wpr_assign_pro_text']) ? $general_settings['mwb_wpr_assign_pro_text'] : __('Product Points',MWB_WPR_Domain);	
		...
		<tbody>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_setting_enable"><?php _e('Enable', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php
					$attribute_description = __('Check this box to enable the plugin.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_general_setting_enable">
						<input type="checkbox" <?php checked($enable_mwb_wpr,1);?> name="mwb_wpr_general_setting_enable" id="mwb_wpr_general_setting_enable" class="input-text"> <?php _e('Enable WooCommerce Points and Rewards',MWB_WPR_Domain);?>
					</label>						
				</td>
			</tr>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_signup"><?php _e('Enable Signup Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check this box to enable the Signup Points.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_general_signup">
						<input type="checkbox" <?php checked($enable_mwb_signup,1);?> name="mwb_wpr_general_signup" id="mwb_wpr_general_signup" class="input-text"> <?php _e('Enable Signup Points for Rewards',MWB_WPR_Domain);?>
					</label>						
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_signup_value"><?php _e('Enter Signup Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('The points which the new customer will get after signup.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_comment_enable"><?php _e('Enable Comments Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check this box to enable the Comments Points when comment is approved.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_general_comment_enable">
						<input type="checkbox" <?php checked($enable_mwb_comment,1);?> name="mwb_wpr_general_comment_enable" id="mwb_wpr_general_comment_enable" class="input-text"> <?php _e('Enable Comments Points for Rewards',MWB_WPR_Domain);?>
					</label>						
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_comment_value"><?php _e('Enter Comments Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('The points which the new customer will get after their comments are approved.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_refer_enable"><?php _e('Enable Referral Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check this box to enable the Referral Points when customer invites another customers.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_general_refer_enable">
						<input type="checkbox" <?php checked($enable_mwb_refer,1);?> name="mwb_wpr_general_refer_enable" id="mwb_wpr_general_refer_enable" class="input-text"> <?php _e('Enable Referral Points for Rewards.',MWB_WPR_Domain);?>
					</label>						
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_refer_value"><?php _e('Enter Referral Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('The points which the customer will get when they successfully invites given number of customers.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_refer_minimum"><?php _e('Minimum Referrals Required', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Minimum number of referrals required to get referral points when the new customer sign ups.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_refer_value_disable"><?php _e('Assign Only Referral Purchase Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check this if you want to assign only purchase points to referred user not referral points.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_general_refer_value_disable">
						<input type="checkbox" <?php checked($mwb_refer_value_disable,1);?> name="mwb_wpr_general_refer_value_disable" id="mwb_wpr_general_refer_value_disable" class="input-text"> <?php _e('Make sure Referral Points & Referral Purchase Points should be enable ',MWB_WPR_Domain);?>
					</label>						
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_referal_purchase_enable"><?php _e('Enable Referral Purchase Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check this box to enable the referral purchase points', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_general_referal_purchase_enable">
						<input type="checkbox" <?php checked($mwb_referral_purchase_enable,1);?> name="mwb_wpr_general_referal_purchase_enable" id="mwb_wpr_general_referal_purchase_enable" class="input-text"> <?php _e('Enable Referral Purchase Points',MWB_WPR_Domain);?>
					</label>						
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_referal_purchase_value"><?php _e('Enter Referral Purchase Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Entered point will assign to that user by which another user reffered from refrral link and purchase some products ', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_referal_purchase_limit"><?php _e('Enable Referral Purchase Limit', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check this box to provide some limitation for referral purchase point, where you can set the number of orders for refree', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_general_referal_purchase_limit">
						<input type="checkbox" <?php checked($mwb_referral_purchase_limit,1);?> name="mwb_wpr_general_referal_purchase_limit" id="mwb_wpr_general_referal_purchase_limit" class="input-text"> <?php _e('Enable limit for Referral Purchase Option',MWB_WPR_Domain);?>
					</label>						
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_referal_order_limit"><?php _e('Set the Number of Orders for Referral Purchase Limit', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Enter the number of orders, Refree would get assigned only till the limit(no of orders) would be reached', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_social_media_enable"><?php _e('Enable Social Links', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check this box to share the Referral Link on social media', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_general_social_media_enable">
						<input type="checkbox" <?php checked($enable_mwb_social,1);?> name="mwb_wpr_general_social_media_enable" id="mwb_wpr_general_social_media_enable" class="input-text"> <?php _e('Enable Social Media Sharing.',MWB_WPR_Domain);?>
					</label>						
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_facebook"><?php _e('Select Social Links', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check these boxes to share referral link', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_facebook">
	                    <input type="checkbox" <?php checked(isset($mwb_social_selection['Facebook'])?$mwb_social_selection['Facebook']:0);?> name="mwb_wpr_facebook" id="mwb_wpr_facebook" class="input-text"><?php _e('Facebook',MWB_WPR_Domain);?>
	                </label>
	                <label for="mwb_wpr_twitter">
	                    <input type="checkbox" <?php checked(isset($mwb_social_selection['Twitter'])?$mwb_social_selection['Twitter']:0);?> name="mwb_wpr_twitter" id="mwb_wpr_twitter" class="input-text"><?php _e('Twitter',MWB_WPR_Domain);?>
	                </label>
	               <!--  <label for="mwb_wpr_google">
	                    <input type="checkbox" <?php checked(isset($mwb_social_selection['Google'])?$mwb_social_selection['Google']:0);?> name="mwb_wpr_google" id="mwb_wpr_google" class="input-text"><?php _e('Google+',MWB_WPR_Domain);?>
	                </label> -->
	                <label for="mwb_wpr_email">
	                    <input type="checkbox" <?php checked(isset($mwb_social_selection['Email'])?$mwb_social_selection['Email']:0);?> name="mwb_wpr_email" id="mwb_wpr_email" class="input-text"><?php _e('Email',MWB_WPR_Domain);?>
	                </label>						
				</td>
			</tr>		
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_text_points" class="mwb_wpr_label"><?php _e('Enter Text', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Entered text will append before the Total Number of Point', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_general_text_points">
						<input type="text" name="mwb_wpr_general_text_points" value="<?php echo $mwb_text_points_value;?>" id="mwb_wpr_general_text_points" class="text_points mwb_wpr_new_woo_ver_style_text"><?php _e('Entered text will get displayed on points page.', MWB_WPR_Domain)?>
					</label>						
				</td>
			</tr>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_general_ways_to_gain_points" class="mwb_wpr_label"><?php _e('Enter Ways to Gain Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Entered ways will get displayed on points page.', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?><span class="description"><?php _e('Use these shortcodes for providing ways to gain points at front end.', MWB_WPR_Domain);?></span>	
					...
					<p class="description"><?php echo '[Refer Points]'; _e(' for Referral Points',MWB_WPR_Domain); echo ' [Comment Points]';_e(' for Comment Points ',MWB_WPR_Domain); echo '[Per Currency Spent Points]'; _e(' for Per currency spent points and',MWB_WPR_Domain); echo '[Per Currency Spent Price]'; _e(' for per currency spent price',MWB_WPR_Domain) ?></p>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_product_purchase_points"><?php _e('Enable Purchase through Points', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check this box to enable puchasing products through points', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_product_purchase_points">
						<input type="checkbox" <?php checked($enable_purchase_points,1);?> name="mwb_wpr_product_purchase_points" id="mwb_wpr_product_purchase_points" class="input-text"> <?php _e('Purchase Products through Points',MWB_WPR_Domain);?>
					</label>						
				</td>
			</tr>
			 <tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_product_purchase_points"><?php _e('Enable restrictions for above setting', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Check this box if you want to allow some of the products for purchasing through points not all', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_restrict_pro_by_points">
						<input type="checkbox" <?php checked($mwb_wpr_restrict_pro_by_points,1);?> name="mwb_wpr_restrict_pro_by_points" id="mwb_wpr_restrict_pro_by_points" class="input-text"> <?php _e('Allow some of the products for purchasing through points',MWB_WPR_Domain);?>
					</label>	
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_restrictions_for_purchasing_cat"><?php _e('Select Product Category', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Select those categories which you want to allow to customers for purchase that product through points', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_purchase_product_text" class="mwb_wpr_label"><?php _e('Enter Text', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Entered text will get displayed on Single Product Page', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_purchase_product_text">
						<input type="text" name="mwb_wpr_purchase_product_text" value="<?php echo $mwb_wpr_purchase_product_text;?>" id="mwb_wpr_purchase_product_text" class="text_points mwb_wpr_new_woo_ver_style_text"><?php _e('Entered text will get displayed on single product page', MWB_WPR_Domain)?>
					</label>						
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_purchase_pro_points_value"><?php _e('Purchase Points Conversion', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Entered points will be converted to price.(i.e., how many points will be equivalent to the product price)', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_points_tab_text" class="mwb_wpr_label"><?php _e('Points Tab Text', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Entered text will be replaced the Points tab at Myaccount Page', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_points_tab_text" class="mwb_wpr_label">
						<input type="text" name="mwb_wpr_points_tab_text" value="<?php echo $mwb_wpr_points_tab_text;?>" id="mwb_wpr_points_tab_text" class="text_points mwb_wpr_new_woo_ver_style_text"><?php _e('Points Tab replaced with your text', MWB_WPR_Domain)?>
					</label>						
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_assign_pro_text"><?php _e('Assigned Product Points Text', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('Enter the message you want to display for those product who have assigned with some of the Points', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
					<label for="mwb_wpr_assign_pro_text">
						<input type="text" name="mwb_wpr_assign_pro_text" value="<?php echo $mwb_wpr_assign_pro_text;?>" id="mwb_wpr_assign_pro_text" class="text_points mwb_wpr_new_woo_ver_style_text"><?php _e('Product Point text can be replaced with entered text', MWB_WPR_Domain)?>
					</label>			
				</td>
			</tr>
			<tr valign="top">		
				<th scope="row" class="titledesc">
					<label for="mwb_wpr_set_preferences"><?php _e('Set Preferences', MWB_WPR_Domain)?></label>
				</th>
				<td class="forminp forminp-text">
					<?php 
					$attribute_description = __('What you want to choose when you have enabled "Per currency Spent Point" and a product with some "Points" assigned ?', MWB_WPR_Domain);
					echo wc_help_tip( $attribute_description );
					?>
	                <label for="mwb_wpr_set_preferences_to_points">
						<input type="radio" <?php echo ($mwb_wpr_set_preferences == 'to_assign_point')?"checked='checked'":""?> name="mwb_wpr_set_preferences" value="to_assign_point"class="mwb_wpr_set_preferences_to_points" id="mwb_wpr_set_preferences_to_points"><?php _e('Only Product Assigned Points',MWB_WPR_Domain);?><br/>
					</label>
	                <label for="mwb_wpr_set_preferences_to_per_currency">
						<input style="margin-left: 23px;" type="radio" <?php echo ($mwb_wpr_set_preferences == 'to_per_currency')?"checked='checked'":""?> name="mwb_wpr_set_preferences" value="to_per_currency"><?php _e('Only Per Currency Spent Point',MWB_WPR_Domain);?><br/>
					</label>
	                <label for="mwb_wpr_set_preferences_to_both">
						<input style="margin-left: 23px;" type="radio" <?php echo ($mwb_wpr_set_preferences == 'to_both')?"checked='checked'":""?> name="mwb_wpr_set_preferences" value="to_both" id="mwb_wpr_set_preferences_to_both"><?php _e('Both',MWB_WPR_Domain);?>
					</label>					
				</td>
			</tr>
		</tbody>
...
<div class="clear"></div>
<p class="submit">
	<input type="submit" value='<?php _e("Save changes",MWB_WPR_Domain); ?>' class="button-primary woocommerce-save-button mwb_wpr_save_changes" name="mwb_wpr_save_general">
</p>