...
$mwb_maxminum_points_value = isset($coupon_settings['mwb_maxminum_points_value']) ? intval($coupon_settings['mwb_maxminum_points_value']) : 10;
?>
...
<p>
	<?php echo __("Generate Coupon:",MWB_WPR_Domain); 
	 echo __("You can generate coupons of ",MWB_WPR_Domain).$mwb_maxminum_points_value.'.';
	?>
</p>
			...
			if($enable_custom_convert_point )
			{
				?>
					<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
						...
						<input type="hidden" class="woocommerce-Input woocommerce-Input--number input-number" value="<?php echo $mwb_maxminum_points_value; ?>" name="mwb_custom_number" min="1" id="mwb_custom_point_num" style="width: 160px;" readonly>
