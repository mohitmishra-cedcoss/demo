...
class Points_Log_List_Table extends WP_List_Table {
    ...
    function get_columns(){
        ...
        $columns = array(
            ...
            'user_email'    => __('User Email', MWB_WPR_Domain),
...
if(isset($_GET['action']) && isset($_GET['user_id']))
{
    if($_GET['action'] == 'view')
    {
        ...
        ?>
        <h1 class="wp-heading-inline" id="mwb_wpr_points_table_heading"><?php _e('User Coupon Details', MWB_WPR_Domain);?></h1>
        <?php
        ...
        {
            echo "<h2>".__('No Coupons Generated Yet.',MWB_WPR_Domain)."<h2>";
        }
        ?><br> 
        <a  href="<?php echo MWB_WPR_HOME_URL; ?>admin.php?page=mwb-wpr-setting&tab=mwb_wpr_points_table" style="line-height: 2" class="button button-primary mwb_wpr_save_changes"><?php _e("Go Back",MWB_WPR_Domain); ?></a> <?php
        ...
        ?>
        <h1 class="wp-heading-inline" id="mwb_wpr_points_table_heading"><?php _e('User Point Log Details', MWB_WPR_Domain);?></h1>
        <?php
        if(isset($point_log) && is_array($point_log) && $point_log != null){
            ...
            <div class="mwb_wpr_wrapper_div">
                <table class="form-table mwp_wpr_settings mwb_wpr_points_view" >
                    <thead>
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <span class="nobr"><?php echo __( 'Date & Time', MWB_WPR_Domain ); ?></span>
                            </th>
                            <th scope="row" class="titledesc">
                                <span class="nobr"><?php echo __( 'Point Status', MWB_WPR_Domain ); ?></span>
                            </th>
                            <th scope="row" class="titledesc">
                                <span class="nobr"><?php echo __( 'Activity', MWB_WPR_Domain ); ?></span>
                            </th>
                        </tr>
                    </thead>
                </table>
                ...
                if(array_key_exists('registration', $point_log)){
                    ...
                    <div class="mwb_wpr_slide_toggle">
                        <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Signup Event',MWB_WPR_Domain);?>
                      ...
                      <table class="form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table" >
                        <tr valign="top">
                            ...
                            <td class="forminp forminp-text"><?php _e('Registration Points', MWB_WPR_Domain);?></td>
                        </tr>
                    </table></div>
                    <?php    
                }
                ...
                if(array_key_exists('Coupon_details', $point_log)){
                    ?>
                    <div class="mwb_wpr_slide_toggle">
                        <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Coupon Generation',MWB_WPR_Domain);?>
                          <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
                      </p> 
                      <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">  
                         <?php 
                         foreach ($point_log['Coupon_details'] as $key => $value) {
                            ...
                            <tr valign="top">
                                ...
                                <td class="forminp forminp-text"><?php _e('Coupon Points', MWB_WPR_Domain);?></td>
                            </tr>
                            <?php 
                        } ?>
                    </table></div> <?php
                ...
                <div class="mwb_wpr_slide_toggle">
                    <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Points on Order',MWB_WPR_Domain);?>
                      <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
                  </p>
                  <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table"> <?php
                     foreach ($point_log['points_on_order'] as $key => $value) {
                        ?>
                        <tr valign="top">
                            <td class="forminp forminp-text"><?php echo $value['date'];?></td>
                            <td class="forminp forminp-text"><?php echo "+".$value['points_on_order'];?></td>
                            <td class="forminp forminp-text"><?php _e('Points earned on Order Total', MWB_WPR_Domain);?></td>
                        </tr>
                        <?php 
                    } ?>
                </table></div>
            ...
            if(array_key_exists('product_details', $point_log)){ ?>
                <div class="mwb_wpr_slide_toggle">
                    <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Assigned Product Point',MWB_WPR_Domain);?>
                      <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
                  </p>
                  <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table"> <?php
                     foreach ($point_log['product_details'] as $key => $value) {
                        ...
                        <tr valign="top">
                            ...
                            <td class="forminp forminp-text"><?php _e('Product purchase Points', MWB_WPR_Domain);?></td>
                        </tr>
                        <?php 
                    } ?>
                </table></div>
            ...
            <div class="mwb_wpr_slide_toggle">
                <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Order Total Points',MWB_WPR_Domain);?>
                  <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
              </p>
              <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
                <?php
                foreach ($point_log['pro_conversion_points'] as $key => $value) {
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text"><?php _e('Product Conversion Points', 'MWB_WPR_Domain');?></td>
                    </tr>
                    <?php 
                } ?>
            </table></div> <?php 
        ...
        <div class="mwb_wpr_slide_toggle">
            <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Product Review Point',MWB_WPR_Domain);?>
              <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
          </p>
          <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
            <?php
            foreach ($point_log['comment'] as $key => $value) {
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-text"><?php _e('Comment Points', MWB_WPR_Domain);?></td>
                </tr>
                <?php 
            } ?>
        </table></div>
    ...
    <div class="mwb_wpr_slide_toggle">
        <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Membership Points',MWB_WPR_Domain);?>
            <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
        </p>
        <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
            <?php
            foreach ($point_log['membership'] as $key => $value) {
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-text"><?php _e('Membership Points', MWB_WPR_Domain);?></td>
                </tr>
                <?php 
            } ?>
        </table></div>
    ...
    if(array_key_exists('reference_details', $point_log)){
        ?>
        <div class="mwb_wpr_slide_toggle">
            <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Referral Earns',MWB_WPR_Domain);?>
              <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
          </p>
          <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table"><?php
             foreach ($point_log['reference_details'] as $key => $value) {
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-text"><?php _e('Reference Points by ', MWB_WPR_Domain); echo $user_name;?></td>
                </tr>
                <?php 
            }
            ?>
    ...
    if(array_key_exists('ref_product_detail', $point_log)){
        ?>
        <div class="mwb_wpr_slide_toggle">
            <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Referral Purchase Point',MWB_WPR_Domain);?>
              <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
          </p>
          <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
            <?php
            foreach ($point_log['ref_product_detail'] as $key => $value) {
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-text"><?php _e('Product purchased by Reffered User Points', MWB_WPR_Domain);?></td>
                </tr>
                <?php 
            } ?>
        </table></div><?php   
    ...
    if(array_key_exists('admin_points', $point_log)){
        ?>
        <div class="mwb_wpr_slide_toggle">
            <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Admin Updates',MWB_WPR_Domain);?>
              <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
          </p>
          <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table"><?php
             foreach ($point_log['admin_points'] as $key => $value) {
                $value['sign'] = isset($value['sign']) ? $value['sign'] : '+/-';
                $value['reason'] = isset($value['reason']) ? $value['reason'] : __('Updated By Admin', MWB_WPR_Domain); 
                ?>
                <tr valign="top">
                    <td class="forminp forminp-text"><?php echo $value['date'];?></td>
    ...
    if(array_key_exists('pur_by_points', $point_log)){
        ?>
        <div class="mwb_wpr_slide_toggle">
            <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Product has been purchased using points',MWB_WPR_Domain);?>
              <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
          </p>
          <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table"><?php
             foreach ($point_log['pur_by_points'] as $key => $value){
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-text"><?php _e('Purchased through Points', MWB_WPR_Domain);?></td>
                </tr>
                <?php 
            }
            ?></table></div> <?php 
        ...
        if(array_key_exists('deduction_of_points', $point_log)){ 
            ?>
            <div class="mwb_wpr_slide_toggle">
                <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Deduction of points for return request',MWB_WPR_Domain);?>
                  <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
              </p>
              <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
                <?php
                foreach ($point_log['deduction_of_points'] as $key => $value){
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text"><?php _e('Deduct Points', MWB_WPR_Domain);?></td>
                    </tr>
                    <?php 
                } ?>
            </table></div> <?php  
        ...
        <div class="mwb_wpr_slide_toggle">
            <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Return Points',MWB_WPR_Domain);?>
              <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
          </p>
          <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
            <?php
            foreach ($point_log['return_pur_points'] as $key => $value){
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-text"><?php _e('Returned Points', MWB_WPR_Domain);?></td>
                </tr>
                <?php 
            } ?>
        </table></div>  
        ...
        <div class="mwb_wpr_slide_toggle">
            <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Deduct Order Total Points',MWB_WPR_Domain);?>
              <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
          </p>
          <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table"> <?php
             foreach ($point_log['deduction_currency_spent'] as $key => $value){
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-text"><?php _e('Deduct Per Currency Spent Point', MWB_WPR_Domain);?></td>
                </tr>
                <?php 
            } ?>
        </table></div><?php
    ...
    <div class="mwb_wpr_slide_toggle">
        <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Shared with',MWB_WPR_Domain);?>
          <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
      </p>
      <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table"> <?php
         foreach ($point_log['Sender_point_details'] as $key => $value) {
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-text"><?php _e('Shared to ', MWB_WPR_Domain); echo $user_name;?></td>
            </tr>
            <?php 
        } ?>
    </table></div>
...
<div class="mwb_wpr_slide_toggle">
    <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Receives Points',MWB_WPR_Domain);?>
      <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
  </p>
  <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
    <?php
    foreach ($point_log['Receiver_point_details'] as $key => $value) {
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text"><?php _e('Received Points by ', MWB_WPR_Domain); echo $user_name;?></td>
        </tr>
        <?php 
    } ?>
</table></div><?php
...
<div class="mwb_wpr_slide_toggle">
    <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Points Applied on Cart',MWB_WPR_Domain);?>
      <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
  </p>
  <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
    <?php
    foreach ($point_log['cart_subtotal_point'] as $key => $value) {
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text"><?php _e('Points Used on Cart Subtotal', MWB_WPR_Domain);?></td>
        </tr>
        <?php 
    } ?>
</table></div><?php
...
<div class="mwb_wpr_slide_toggle">
    <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Expired Points',MWB_WPR_Domain);?>
      <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
  </p>
  <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
    <?php
    foreach ($point_log['expired_details'] as $key => $value) {
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text"><?php _e('Get Expired', MWB_WPR_Domain);?></td>
        </tr>
        <?php 
    } ?>
</table></div>
...
<div class="mwb_wpr_slide_toggle">
    <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Order Points Deducted due to Cancelation of Order',MWB_WPR_Domain);?>
      <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
  </p>
  <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
    <?php
    foreach ($point_log['deduct_currency_pnt_cancel'] as $key => $value) {
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text"><?php _e('Deducted Points', MWB_WPR_Domain);?></td>
        </tr>
        <?php 
    } ?>
</table></div>
...
<div class="mwb_wpr_slide_toggle">
    <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Assigned Points Deducted due to Cancelation of Order',MWB_WPR_Domain);?>
      <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
  </p>
  <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
    <?php
...
<div class="mwb_wpr_slide_toggle">
    <p class="mwb_wpr_view_log_notice mwb_wpr_common_slider" ><?php _e('Points Returned due to Cancelation of Order',MWB_WPR_Domain);?>
      <a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
  </p>
  <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
    <?php
  ...
  <table class = "form-table mwp_wpr_settings mwb_wpr_points_view mwb_wpr_common_table">
    ...
    foreach ($point_log['pur_pro_pnt_only'] as $key => $value) {
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text"><?php _e('Product Purchased by Points', MWB_WPR_Domain);?></td>
        </tr>
        <?php 
    } ?>
</table></div><?php
...
<table class = "form-table mwp_wpr_settings mwb_wpr_points_view">
    <tr valign="top">
        <td class="forminp forminp-text"><strong><?php _e('Total Points', MWB_WPR_Domain);?></strong></td>
...
<?php    
   ...
   echo "<h2>".__('No Points Generated Yet.',MWB_WPR_Domain)."<h2>";
}
}
}
else
{
    ?>
    <h1 class="wp-heading-inline" id="mwb_wpr_points_table_heading"><?php _e('Points Table', MWB_WPR_Domain);?></h1>
    <?php
    $general_settings = get_option('mwb_wpr_settings_gallery',true);
    ...
    if($enable_mwb_signup )
    {
        ...
        {   
            ...
            <div class="mwb_wpr_import_user container">
                <h3>
                    <?php _e('Import Users',MWB_WPR_Domain); ?>
                </h3>
                <p>
                    <?php _e('Import existing users and assign them with Sign Up Points',MWB_WPR_Domain); ?>
                </p>
                <input type="submit" value="<?php _e('Import', MWB_WPR_Domain);?>" id="mwb_wpr_import" class="page-title-action button button-primary button-large mwb_wpr_save_changes" name="mwb_wpr_import_user">
            </div>
            ...
            if($guest_flag){
                ...
                <div class="mwb_wpr_import_user container">
                    ...
                    <input type="button" value="<?php _e('Import', MWB_WPR_Domain);?>" id="mwb_wpr_import" class="page-title-action button button-primary button-large mwb_wpr_save_changes" name="mwb_wpr_import_user">
                </div>
    ...
    <form method="post">
        ...
        $myListTable->search_box( __( 'Search Users',MWB_WPR_Domain ), 'mwb-wpr-user' );
        $myListTable->display();
        ?>
    </form>
    <?php
